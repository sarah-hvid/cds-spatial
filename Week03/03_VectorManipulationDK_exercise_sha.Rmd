...
municipalities_tf1 <- st_transform(st_as_sf(municipalities), crs = 25832)
...
# getting the crs of the aarhus object
the_crs <- crs(aarhus_mun, asText = TRUE)
the_crs1 <- crs(shelters_buf_2, asText = TRUE)

# creating a new shelters_buf, with the crs from aarhus
shelters_buf2 <- projectRaster(shelters_buf, crs = the_crs, method = 'ngb')
shelters_buf_2 <- st_transform(shelters_buf, crs = the_crs)
...
plot(shelters_buf, pch = 16, col = "forestgreen", add = TRUE)

# Compute the coordinates of the bounding box
st_bbox(aarhus_mun)

# Create a bounding box polygon
aarhus_box <- st_bbox(aarhus_mun, n = 1)

# Plot all the DK municipalities, add the shelters and the new box outlining the Aarhus municipality
plot(st_geometry(municipalities_tf), col = "grey", border = "white")
plot(shelters_buf_2, add = TRUE, pch = 16, col = "forestgreen")
